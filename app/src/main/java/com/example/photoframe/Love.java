...
public class Love extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Love Frames");
        ColorDrawable colorDrawable=new ColorDrawable(Color.parseColor("#808080"));
        actionBar.setBackgroundDrawable(colorDrawable);

        GridView gridView = findViewById(R.id.loveGridviewID);
        ...
        gridView.setOnItemClickListener((adapterView, view, i, l) -> {
           ...
           // Toast.makeText(Love.this, "" + i + " is clicked", Toast.LENGTH_SHORT).show();

            Intent intent = new Intent(Love.this, Editor.class);
            intent.putExtra("i",i);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Love.this, Create.class);
        startActivity(intent);
        finish();
        super.onBackPressed();
    }
